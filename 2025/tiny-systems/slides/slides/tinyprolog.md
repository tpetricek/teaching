...
- *fa-right-left* Remarkably similar to ML type inference!
- *fa-lightbulb* This is not a coincidence...
- *fa-magnifying-glass* Evaluation as search, not a sequence of steps
- *fa-gears* Much work needed to make this practical
